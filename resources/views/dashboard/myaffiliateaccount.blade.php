          ...
          <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            ...
            <div class="w-full sm:w-auto">
              <div class="bg-white bg-opacity-20 p-4 rounded-xl">
                <p class="text-sm mb-2">You earn for 50% for life</p>
...
<div class="flex justify-center mb-6">
  <div class="flex space-x-3 bg-blue-200 p-3 rounded-xl shadow-md">
    
    <!-- Facebook -->
    <a href="#" class="w-10 h-10 rounded-full bg-[#1877F2] flex items-center justify-center text-white hover:scale-110 transition">
      <i class="fab fa-facebook-f"></i>
    </a>

    <!-- Pinterest -->
    <a href="#" class="w-10 h-10 rounded-full bg-[#E60023] flex items-center justify-center text-white hover:scale-110 transition">
      <i class="fab fa-pinterest-p"></i>
    </a>

    <!-- Instagram -->
    <a href="#" class="w-10 h-10 rounded-full bg-gradient-to-tr from-pink-500 to-purple-500 flex items-center justify-center text-white hover:scale-110 transition">
      <i class="fab fa-instagram"></i>
    </a>

    <!-- TikTok -->
    <a href="#" class="w-10 h-10 rounded-full bg-black flex items-center justify-center text-white hover:scale-110 transition">
      <i class="fab fa-tiktok"></i>
    </a>

    <!-- Twitter -->
    <a href="#" class="w-10 h-10 rounded-full bg-[#1DA1F2] flex items-center justify-center text-white hover:scale-110 transition">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
  ...
  <div class="bg-blue-100 border border-blue-300 rounded-lg p-4">
    ...
    <ul class="space-y-2 text-sm text-blue-900">
      <li>Williams Julin</li>
      <li>Simone Blanc</li>
      <li>Christian Julin</li>
    </ul>
  </div>
...
<div class="flex justify-center mt-4 mb-12">
  ...
  <a href="/myearningsnpayments">  My earnings & my payments </a>
  </button>
</div>
