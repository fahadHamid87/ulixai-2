<?php
$activeTab = isset($_GET['tab']) && $_GET['tab'] === 'jobs' ? 'jobs' : 'services';
?>
        ...
        <div class="space-y-4">
          ...
          <div class="message-card border rounded-xl p-4 bg-white flex items-center gap-4 cursor-pointer hover:shadow-lg transition"
            ...
            <div class="flex-1 space-y-1">
              ...
              <a href="/editcomplete" class="inline-block bg-blue-600 text-white text-xs font-semibold rounded-full px-4 py-2 mt-2 hover:bg-blue-700 transition">
                See My Job
              </a>
            </div>
