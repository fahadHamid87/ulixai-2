      ...
      <div class="bg-white rounded-2xl shadow-xl p-6 sm:p-8 max-w-3xl mx-auto">
        ...
        <div class="mb-6">
          ...
          <div class="flex flex-col sm:flex-row gap-4 text-sm">
            <label><input type="radio" name="service_success" class="mr-1" checked> Yes</label>
            <label><input type="radio" name="service_success" class="mr-1"> No</label>
          </div>
        </div>
                ...
                echo '
                  <div class="flex justify-between items-center border rounded-full px-4 py-2 text-sm bg-white shadow-sm">
                    ...
                    <div class="flex gap-2">
                      <button class="bg-red-100 text-red-600 rounded-full px-2">✕</button>
                      <button class="bg-green-100 text-green-600 rounded-full px-2">✔</button>
                    </div>
                  </div>';
              }
            ?>
        ...
        <div class="mb-6">
          ...
          <textarea rows="4" class="w-full border rounded-xl p-4 text-sm placeholder-gray-400 resize-none" placeholder="Leave the comment here"></textarea>
        ...
        <div class="text-center sm:text-right">
          <a href="/reviewzelpy" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-full font-semibold text-sm transition duration-300">
            I CONFIRM
          </a>
        </div>
      </div>
